...
自从2013年建了第一个个人网站（博客搭建，传送门：[如何一步一步建立一个属于你自己的个人网站？](http://www.longluo.me/blog/2016/09/09/How-To-Build-Your-Personal-Website-Step-By-Step/)），折腾了好几个博客系统。

第一个网站购买了VPS，使用LNMP架构，博客系统使用Wordpress。使用了半年左右，觉得Wordpress太重了，看到了其他技术博主使用[Octopress](http://octopress.org/)，简洁，于是切换到Octopress。

最近一次则是[Hexo](https://hexo.io)，非常简洁，而且很快，于是很快将个人网站切换到Hexo。

目前使用Hexo+Next主题，非常简洁。

这里记录一些Hexo

最开始是讲述了如何利用Github Pages建立一个属于自己的静态博客，下面这篇文章主要讲的是hexo的常见指令及说明，定位于**Hexo的入门指南**。
