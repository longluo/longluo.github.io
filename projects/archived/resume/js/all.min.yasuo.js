    ...
    random: function (e, t) {
        ...
        function l() {
            ...
            f.push(n), setTimeout(function () {
                var t = e.text(703, 250, "{ 2 年 }\n前端开发经验").attr({"font-size": 22, fill: "#fff", "font-family": s});
                f.push(t)
            }, 1e3)
        }

        var e = Raphael("skillsArc", 830, 500), t = 73, n = "Skills", r = 250;
        ...
        var i = e.text(250, 250, n).attr({
            ...
            fill: "#fff"
        }).toFront(), s = "Hiragino Sans GB, Microsoft YaHei, sans-serif";
        e.customAttributes.arc = function (e, t, n) {
            var r = 3.6 * e, i = r == 360 ? 359.99 : r, s = (90 - i) * Math.PI / 180, o = 250 + n * Math.cos(s),
                u = 250 - n * Math.sin(s), a = [["M", 250, 250 - n], ["A", n, n, 0, +(i > 180), 1, o, u]];
            return {path: a, stroke: t}
        };
        var u = e.circle(702, 20, 5).attr({stroke: "none", fill: "#228fbd"}), a = e.path("M 702 20 L 702 20").attr({
            fill: "none",
            stroke: "#228fbd",
            "stroke-width": 1
        }).animate({path: "M702 20 L 702 180"}, 1e3, ">", l), f = e.set();
        f.push(u), f.push(a);
        var c = [{kind: "JavaScript", score: "70", color: "#97BE0D"}, {
            kind: "CSS",
            score: "90",
            color: "#D84F5F"
        }, {kind: "HTML", score: "95", color: "#88B8E6"}, {
            kind: "PHP&Python",
            score: "53",
            color: "#BEDBE9"
        }, {kind: "Others", score: "45", color: "#EDEBEE"}], h = e.set(), p = {
            "arc-javascript": [[300, "jQuery"], [250, "Native Javascript"], [150, "Raphael&D3"], [140, "NodeJS"], [120, "coffee"]],
            "arc-html": [[300, "HTML4/XHTML"], [200, "HTML5"], [100, "XML"]],
            "arc-css": [[300, "CSS2.1"], [250, "浏览器兼容"], [200, "CSS3"], [100, "LESS"]],
            "arc-php_python": [[120, "PHP"], [100, "Python"]],
            "arc-others": [[100, "SEO"], [100, "MySQL"], [100, "Java"], [100, "C++"]]
        }, d = 30, v = 550, m = 150, g = v + 10;
        setTimeout(function () {
            for (var u = 0; u < c.length; u++) {
                var a = c[u], l = a.color, y = a.score, b = a.kind, w = "arc-" + b.toLowerCase().replace("&", "_");
                t += 30;
                var E = e.path().attr({arc: [y, l, t], "stroke-width": 26});
                E.node.id = w, function (t, u, a) {
                    o("mouseover", E), o("mouseout", E), E.mouseover(function () {
                        this.animate({
                            "stroke-width": 50,
                            opacity: .75
                        }, 1e3, "elastic"), Raphael.type != "VML" && this.toFront(), i.stop().animate({opacity: 0}, r, ">", function () {
                            this.attr({text: a + "\n" + u + "%"}).animate({opacity: 1}, r, "<")
                        });
                        var n = this.node.id;
                        for (var o = 0, l = p[n]; o < l.length; o++) {
                            var c = d + 10, y = e.rect(v, m + c * o, 1, d).attr({
                                    fill: t,
                                    stroke: "none"
                                }).animate({width: l[o][0]}, 2e3 * Math.random(), "bounce"),
                        ...
                        this.stop().animate({
                            "stroke-width": 26,
                            opacity: 1
                        }, r * 4, "elastic"), i.stop().animate({opacity: 0}, r, ">", function () {
                            i.attr({text: n}).animate({opacity: 1}, r, "<")
                        }), console.log(h.length), h.length > 0 && (h.forEach(function (e) {
                            e.remove()
                        }), h.clear()), f.forEach(function (e) {
        ...
        var e = {fill: "#285AA9", "stroke-width": 0, opacity: .5}, t = "t-240,-240s0.07",
        ...
        function i() {
            e.path("M300 130 L 300 130").attr({
                ...
                stroke: "#000",
                "stroke-width": 1
            }).animate({path: "M300 130 L 300 600 l 300 600"}, 1e3, "backOut");
            for (var n = 0; n < t.length; n++) {
                ...
                (function (r) {
                    e.circle(300, 1500, r).attr({
                        stroke: "none",
                        fill: t[n][2]
                    }).animate({cy: t[n][0]}, 1e3 + 1e3 * Math.random(), "backOut").hover(function () {
                        this.animate({r: r * 1.5}, 500, "bounce")
                    }, function () {
                        this.animate({r: r}, 500, "bounce")
                    })
                })(i), e.text(360, 1500, t[n][3]).attr({
                    "font-size": 14,
                    fill: "#649996",
                    "font-family": r,
                    "text-anchor": "start"
                }).animate(Raphael.animation({y: t[n][0]}, 1e3, "backOut").delay(1e3)), e.text(360, 1500, t[n][4]).attr({
                    "font-size": 16,
                    fill: "#898989",
                    "font-family": r,
                    "text-anchor": "start"
                }).animate(Raphael.animation({y: t[n][0] + 25}, 1e3, "backOut").delay(1e3)), e.text(360, 1500, t[n][5]).attr({
                    "font-size": 14,
                    fill: "#898989",
                    "font-family": r,
                    "text-anchor": "start"
                }).animate(Raphael.animation({y: t[n][0] + 50}, 1e3, "backOut").delay(1e3))
            }
        }

        var e = new Raphael("experienceTimeLine", 900, 680),
            t = [[200, 25, "#97BE0D", "2009.09 - 2013.07，广东，广州", "计算机专业 本科 (华南理工大学)", ""], [300, 20, "#88B8E6", "2009.10 - 2011.06", "南校B7计算机中心", "助理"], [400, 10, "#88B8E6", "2011.07 - 2012.02", "广州赛麟信息技术有限公司", "兼职网站开发，负责公司网站建设和维护"], [500, 10, "#88B8E6", "2012.07 - 2013.02", "广州一刻影像科技有限公司", "Web前台开发，负责一刻网（ikefoto.com）维护和重构、改版工作"], [600, 20, "#989898", "2013.07 - 至今", "百度", ""]],
            n = [["#97BE0D", 400, "学习"], ["#88B8E6", 530, "工作经历"]], r = "Hiragino Sans GB, Microsoft YaHei, sans-serif";
        e.text(0, 95, "1991年7月，出生").attr({
            "font-size": 16,
            fill: "#898989",
            "font-family": r,
            "text-anchor": "start"
            ...
            stroke: "#000",
            "stroke-width": 1
        }).animate({path: "M 130 95 L 170 95 176 88 182 105 188 95 260 95 300 130 385 45"}, 1e3, "bounce", i);
        ...
        var e = "M28.936,2.099H2.046c-0.506,0-0.919,0.414-0.919,0.92v21.097c0,0.506,0.413,0.919,0.919,0.919h17.062v-0.003h9.828c0.506,0,0.92-0.413,0.92-0.921V3.019C29.854,2.513,29.439,2.099,28.936,2.099zM28.562,20.062c0,0.412-0.338,0.75-0.75,0.75H3.062c-0.413,0-0.75-0.338-0.75-0.75v-16c0-0.413,0.337-0.75,0.75-0.75h24.75c0.412,0,0.75,0.337,0.75,0.75V20.062zM20.518,28.4c-0.033-0.035-0.062-0.055-0.068-0.062l-0.01-0.004l-0.008-0.004c0,0-0.046-0.021-0.119-0.062c-0.108-0.056-0.283-0.144-0.445-0.237c-0.162-0.097-0.32-0.199-0.393-0.271c-0.008-0.014-0.035-0.079-0.058-0.17c-0.083-0.32-0.161-0.95-0.22-1.539h-7.5c-0.023,0.23-0.048,0.467-0.076,0.691c-0.035,0.272-0.073,0.524-0.113,0.716c-0.02,0.096-0.039,0.175-0.059,0.23c-0.009,0.025-0.018,0.05-0.024,0.062c-0.003,0.006-0.005,0.01-0.007,0.013c-0.094,0.096-0.34,0.246-0.553,0.36c-0.107,0.062-0.209,0.11-0.283,0.146c-0.074,0.037-0.119,0.062-0.119,0.062l-0.007,0.004l-0.008,0.004c-0.01,0.009-0.038,0.022-0.07,0.062c-0.031,0.037-0.067,0.103-0.067,0.185c0.002,0.002-0.004,0.037-0.006,0.088c0,0.043,0.007,0.118,0.068,0.185c0.061,0.062,0.143,0.08,0.217,0.08h9.716c0.073,0,0.153-0.021,0.215-0.08c0.062-0.063,0.068-0.142,0.068-0.185c-0.001-0.051-0.008-0.086-0.007-0.088C20.583,28.503,20.548,28.439,20.518,28.4z",
            ...
            n = {fill: "#005687", "stroke-width": 0}, r = new Raphael("projectsGallery", 980, 605),
            i = ["project_ike.png", "project_imettoimage.png", "project_yuyue.png", "project_acechics.jpg", "project_circle_sina.png", "project_tinna_audio_ebay_store.png", "project_aizuoye.png"],
            s = [737, 919, 1111, 332, 609, 558], o = "img/thumb2/",
            u = r.image(o + i[0], 278, 26, 473, 315).attr({"clip-rect": "278, 26, 473, 315", opacity: 1}), a = 0,
        ...
        var l = r.path("M6.73,45.2 0,38.47 15.868,22.601 0,6.731 6.73,0 29.332,22.601 z").attr({
                ...
                opacity: 0,
                stroke: "none"
            }).transform("t900 300").animate({opacity: 1}, 500, "bouce"),
            c = r.path("M22.702,0 29.332,6.73 13.464,22.6 29.332,38.469 22.702,45.2 0,22.6 z").attr({
                ...
                stroke: "none",
                zIndex: 999
            }).transform("t0 300").animate({opacity: 1}, 500, "bouce");
        c.translate(40, 200), l.translate(40, 200), l.click(function () {
            $("#projectIntro table").eq(a).fadeOut(1e3), a++, a > i.length - 1 && (a = 0);
            var e = t[a % t.length], n = t[(a + 1) % t.length];
            f.animate({fill: e}, 1e3, "bouce"), l.animate({fill: e}, 1e3, "bouce"), c.animate({fill: e}, 1e3, "bouce"), u.animate({opacity: 0}, 3e3, "bouce").attr({
                src: o + i[a],
                opacity: 0
            }).animate({opacity: 1}, 3e3, "bouce"), $("#projectIntro table").eq(a).fadeIn(1e3), $("#galleryCursor .cursor").text(a + 1).css({color: e}), $("#galleryCursor .total").css({color: n})
        }), c.click(function () {
        ...
        }), $("#galleryCursor .cursor").text(1).css({color: t[0]}), $("#galleryCursor .total").text(i.length).css({color: t[1]}), $("#galleryCursor").fadeIn(2e3)
    }
};
$(function () {
    var e = ["intro", "skills", "experiences", "projects", "final"], t = [!1, !1, !1, !1, !1], n = [], r = 0,
        i = $(window).height();
    for (var s = 0; s < e.length; s++) n[s] = $("#" + e[s]).offset().top;
    var o = [];
    o[0] = function () {
        $.browser.msie && $("#" + e[0] + " h2").animate({opacity: 1}, 2e3), NemoCV.drawIcons(), $(".leftBracket").animate({
            left: "-50",
            opacity: 1
        }, 1500), $(".rightBracket").animate({
            right: "-50",
            opacity: 1
        }, 1500), $("#intro .text, #intro .contact").fadeIn(2e3), $("#intro .down").queue(function (e) {
            $(this).animate({top: "30px", opacity: .7}, 800).delay(500).animate({
                top: "0px",
                opacity: 1
            }, 800), $(this).queue(arguments.callee), e()
        }).click(function () {
            r++, $("html, body").stop().animate({scrollTop: n[r] + 100}, 2e3, "easeOutBack")
        }), $("#sideNav .down").queue(function (e) {
            $(this).animate({marginTop: "35px", opacity: .7}, 800).delay(500).animate({
                marginTop: "10px",
                opacity: 1
            }, 800), $(this).queue(arguments.callee), e()
        }).click(function () {
            r++, $("html, body").stop().animate({scrollTop: n[r] + 200}, 1e3, "easeOutBack")
        }), $("#sideNav .up").click(function () {
            r--;
            var e = r == 0 ? 0 : n[r] + 150;
            $("html, body").stop().animate({scrollTop: e}, 1e3, "easeOutBack")
        })
    }, o[1] = function () {
        $(".legend h3").addClass("fadeInUp"), $(".skillsList li").each(function (e) {
            var t = $(this);
            setTimeout(function () {
            ...
            e = e.replace(/&/, "_"), $("#" + e).trigger("mouseover")
        }, function () {
            var e = "arc-" + $(this).text().toLowerCase();
            e = e.replace(/&/, "_"), $("#" + e).trigger("mouseout")
        }), NemoCV.drawSkillsArc()
    }, o[2] = function () {
        NemoCV.drawExperienceTimeLine()
    }, o[3] = function () {
        NemoCV.drawProjectsGallery(), $("#projectsGallery").addClass("bounceInDown"), $("#projectIntro table").eq(0).fadeIn(2e3)
    }, o[4] = function () {
        $("#final .text").animate({opacity: 1}, 2e3), $("#final .backTop").click(function () {
            $("html, body").stop().animate({scrollTop: 0}, 2e3, "easeOutBack")
        })
    }, $(window).scroll(function () {
        var s = $(this).scrollTop();
        for (var u = e.length; u > 0; u--) if (s > n[u] - i + 300) {
            t[u] || ($("#" + e[u] + " h2").addClass("fadeInLeftBig"), $.browser.msie && $("#" + e[u] + " h2").animate({opacity: 1}, 2e3), o[u](), t[u] = !0);
            break
        }
        r = u, s > n[1] - 100 ? $("#sideNav").fadeIn(1e3) : ($("#sideNav").fadeOut(1e3), r = 0)
    }), o[0](), t[0] = !0
})