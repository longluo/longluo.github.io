var FrankLuoCV = {
                ...
                E.node.id = w, function (t, u, a) {
                    o("mouseover", E), o("mouseout", E), E.mouseover(function () {
                        this.animate({
                            "stroke-width": 50,
                            opacity: .75
                        }, 1e3, "elastic"), Raphael.type != "VML" && this.toFront(), i.stop().animate({
                            opacity: 0
                        }, r, ">", function () {
                            this.attr({
                                text: a + "\n" + u + "%"
    ...
    drawExperienceTimeLine: function () {
        function i() {
            ...
            for (var n = 0; n < t.length; n++) {
                ...
                (function (r) {
                    ...
                    y: t[n][0]
                }, 1e3, "backOut").delay(1e3)), e.text(360, 1500, t[n][4]).attr({
                    "font-size": 16,
                    fill: "#898989",
                    "font-family": r,
                    "text-anchor": "start"
                    ...
                    y: t[n][0] + 25
                }, 1e3, "backOut").delay(1e3)), e.text(360, 1500, t[n][5]).attr({
                    "font-size": 14,
                    fill: "#898989",
                    "font-family": r,
                    "text-anchor": "start"
        ...
        var e = new Raphael("experienceTimeLine", 900, 680),
            t = [
                [200, 25, "#97BE0D", "2005.09 - 2009.06", "电子科技大学(成都)", "通信工程专业学习", ],
                [300, 20, "#88B8E6", "2009.08 - 2010.07", "理光(深圳)工业发展有限公司", "嵌入式软件工程师，负责开发电子元器件如电机、风扇、电源等检测设备", ],
                [400, 10, "#88B8E6", "2010.07 - 2011.06", "深圳世纪天元通信有限公司", "负责MTK平台手机软件开发，开发了键盘、音乐播放器、文件管理器等"],
                [500, 20, "#989898", "2011.07 - 至今", "OPPO", "负责ColosOS内置文件管理器、视频App的维护、重构工作"]
            ],
            n = [
                ["#97BE0D", 400, "学习"],
                ["#88B8E6", 530, "工作经历"]
    ...
    drawProjectsGallery: function () {
        ...
        c.translate(40, 200), l.translate(40, 200), l.click(function () {
            ...
            f.animate({
                ...
                opacity: 1
            }, 3e3, "bouce"), $("#projectIntro table").eq(a).fadeIn(1e3), $("#galleryCursor .cursor").text(a + 1).css({
                color: e
...
$(function () {
    ...
    o[0] = function () {
        $.browser.msie && $("#" + e[0] + " h2").animate({
            opacity: 1
        }, 2e3), FrankLuoCV.drawIcons(), $(".leftBracket").animate({
            left: "-50",
            opacity: 1
        ...
        }), FrankLuoCV.drawSkillsArc()
    }, o[2] = function () {
        FrankLuoCV.drawExperienceTimeLine()
    }, o[3] = function () {
        FrankLuoCV.drawProjectsGallery(), $("#projectsGallery").addClass("bounceInDown"), $("#projectIntro table").eq(0).fadeIn(2e3)
    }, o[4] = function () {
        $("#final .text").animate({
            opacity: 1
        }, 2e3), $("#final .backTop").click(function () {
            $("html, body").stop().animate({
                scrollTop: 0
            }, 2e3, "easeOutBack")
        })
